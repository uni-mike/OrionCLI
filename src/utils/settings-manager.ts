...
export class SettingsManager {
  private static instance: SettingsManager;
  static getInstance() { if (!this.instance) this.instance = new SettingsManager(); return this.instance; }
  async load() {}
  get(key: string, defaultValue?: any) { return defaultValue; }
  set(key: string, value: any) {}
  getAll() { return {}; }
  async save() {}
  async isFirstRun() { return false; }
